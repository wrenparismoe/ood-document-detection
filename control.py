...
class ModelControl(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_cos_loss", cos_loss.item(), on_step=True, on_epoch=True, prog_bar=True, logger=True)
    ...
    def validation_step_end(self, validation_step_outputs):
        # NOTE: Unsure about output structure from validation_step(), so this may need to be changed
